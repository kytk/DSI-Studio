...
template<typename value_type,unsigned int w>  struct weight               {value_type operator()(value_type value)    {return value*w;}};
...
template<unsigned int weight_value,typename dest_type,typename src_type>
