...
protected:
    ...
    std::vector<std::vector<unsigned int> > swap_pair1,swap_pair2;
...
protected:
    ...
    void fft(ImageType& real,ImageType& img,bool invert)
    {
        ...
        for(int dim = 0;dim < dimension;++dim)
        {
            typename std::vector<unsigned int>::const_iterator iter = swap_pair1[dim].begin();
            typename std::vector<unsigned int>::const_iterator end = swap_pair1[dim].end();
            typename std::vector<unsigned int>::const_iterator iter2 = swap_pair2[dim].begin();
