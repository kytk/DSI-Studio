...
public:
    ...
    transformation_matrix(const affine_transform<dimension,value_type>& rb)
    {
    ...
    transformation_matrix(const rigid_scaling_transform<dimension,value_type>& rb)
    {
        rotation_scaling_matrix(rb.rotation,rb.scaling,scaling_rotation,vdim<dimension>());
        std::copy(rb.translocation,rb.translocation+dimension,shift);
    }
    transformation_matrix(const rigid_body_transform<dimension,value_type>& rb)
    {
        rotation_matrix(rb.rotation,scaling_rotation,vdim<dimension>());
        std::copy(rb.translocation,rb.translocation+dimension,shift);
    }
