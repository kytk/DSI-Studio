...
private:
    ...
    std::pair<attribute_type,attribute_type> get_value_range(attributes_iterator_type attributes_from,
            attributes_iterator_type attributes_to,unsigned int attribute_index)
    {
                            ...
                            classifications_iterator_type classifications_from)
    {
        ...
        unsigned int n_x0 = 0;
        unsigned int n_x1 = 0;
        unsigned int n_y0_x0 = 0;
        unsigned int n_y1_x0 = 0;
        unsigned int n_y0_x1 = 0;
        unsigned int n_y1_x1 = 0;
...
private:
    ...
    double param;
    unsigned int minimum_sample;
    double termination_ratio;
    bool is_end_node;
    bool end_node_decision;
public:
    decision_tree(unsigned int minimum_sample_,double termination_ratio_):
               ...
               classifications_iterator_type classifications_from)
    {
        ...
        {
            unsigned int n_y0 = std::count(classifications_from,classifications_to,0);
            unsigned int n_y1 = sample_size - n_y0;
        ...
        // decision the best decision
        {
            ...
            std::vector<std::pair<unsigned int,double> > decision_list;
            ...
            for (unsigned int index = 0;index < decision_list.size();++index)
            {
            ...
            unsigned int best_decision_index = std::max_element(ig.begin(),ig.end())-ig.begin();
