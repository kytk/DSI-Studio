...
public:
    ...
    ada_boost(unsigned int max_iteration_):alpha_threshold(0.0),max_iteration(max_iteration_) {}

    const method_type& get(unsigned int index) const
    {
               ...
               classifications_iterator_type classifications_from)
    {
        ...
        for (unsigned int t = 0;t < max_iteration;++t)
        {
